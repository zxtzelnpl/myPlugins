...
function chart4() {
    ...
    function writeText(ctx, obj) {
        var fontSize = (obj.fontSize || 12) * delta;
    ...
    function paintYLine(ctx, obj) {
        ...
        var x = obj.x * delta;
        var y = obj.y * delta;
        var width = obj.width * delta;
        var lineWidth = obj.line.width * delta;
